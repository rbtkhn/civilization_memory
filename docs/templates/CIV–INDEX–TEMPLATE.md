...
Compatibility: CIV–MEM–CORE v3.4 · CIV–MEM–TEMPLATE v3.4 · CIV–SCHOLAR–TEMPLATE v3.4
...
• MEM–GERMANY–HANSEATIC–LEAGUE (TSP:NETWORK)
...
• MEM–ANGLIA–ROTHSCHILD (TSP:NETWORK) → GERMANY, FRANCE
• MEM–GERMANY–ROTHSCHILD (TSP:NETWORK) → ANGLIA, FRANCE
...
Reference: CIV–MEM–CORE v3.4, Section XXIX
...
• MEM–[CIV]–[TERRITORY]–[CITY] (e.g., MEM–GERMANY–BAVARIA–MUNICH)
...
────────────────────────────────────────────────────────────
END OF FILE — CIV–INDEX–TEMPLATE v3.4
────────────────────────────────────────────────────────────
