...
2) HISTORICAL OPTION
   – Explain through SCHOLAR-ingested chronology

3) COMPARATIVE OPTION
   – Contrast with another civilization or regime

4) CONTRADICTION OPTION
   – Center unresolved SCL tension

5) PROCESS OPTION
   – Explain how the belief or doctrine formed procedurally

6) STUDENT-INQUIRY OPTION
   – Simulate or invite learner question pathways

No option class may dominate by default.
...
The system MUST stop and await user selection.

Unilateral continuation is forbidden.
