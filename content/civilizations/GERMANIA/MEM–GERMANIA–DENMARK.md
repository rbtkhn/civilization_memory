MEM–GERMANIA–DENMARK — v2.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL · ARC-COMPLIANT

Status: ACTIVE
Version: 2.0
Supersedes: MEM–GERMANIA–DENMARK v1.0
...
The Sound Dues institutionalize this leverage:
...
German legal claims conflict with Danish dynastic rule:
...
Outcomes:
• Loss of duchies (Schleswig, Holstein, Lauenburg)
...
• Political disengagement from continental affairs
• NATO/EU integration post-WWII
...
• MEM–GERMANIA–WAR–DANO–PRUSSIAN (1864 resolution)
• MEM–GERMANIA–NORWAY (through Denmark)
• MEM–GERMANIA–BISMARCK (limited war exemplar)
• MEM–GERMANIA–WAR–VIKINGS (historical pressure)

Cross-Civilizational:
• MEM–ANGLIA (maritime interest in Sound)
• MEM–SWEDEN (Baltic rivalry)
...
• Access is a form of power distinct from territory.
...
A) Why did the Schleswig-Holstein question persist so long?
B) Compare Sound Dues to modern trade chokepoints.
C) How did 1864 differ from later German wars?
D) Why did Denmark choose neutrality after 1871?
...
────────────────────────────────────────────────────────────
Primary:
• Petition to Imperial Diet, Augsburg (1548)
• Christian IV, Royal Proclamation (1625)
• Prussian State Memorandum (1848)
• Bismarck, Reichstag Speech (1864)
...
────────────────────────────────────────────────────────────
Primary Source Verbatim: 4 quotes (petitions, proclamations, Bismarck)

20% Quote Standard: MET (~22% verbatim content)
EQS Status: COMPLIANT

────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANIA–DENMARK — v2.0
────────────────────────────────────────────────────────────
