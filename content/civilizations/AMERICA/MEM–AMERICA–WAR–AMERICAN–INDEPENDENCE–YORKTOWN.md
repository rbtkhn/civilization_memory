...
────────────────────────────────────────────────────────────
This file preserves Yorktown as America's encoding of the decisive
nodal victory in the War of Independence: the siege (Sep–Oct 1781)
in which Washington and Rochambeau, with French naval blockade,
force Cornwallis surrender and trigger British strategic
reassessment, leading to Treaty of Paris (1783) and recognition of
independence. Yorktown does not destroy British power; it makes
continued war untenable. Victory through coalition and endurance.
...
────────────────────────────────────────────────────────────
Cornwallis in Virginia; French fleet under de Grasse enters
Chesapeake; Washington and Rochambeau march south. British naval
...
────────────────────────────────────────────────────────────
Yorktown encodes decisive victory through alliance and endurance;
independence sealed when Britain cannot hold the theatre;
procedural surrender and Treaty of Paris as recognition.

────────────────────────────────────────────────────────────
IV. MEM CONNECTIONS (MANDATORY)
────────────────────────────────────────────────────────────
AMERICA:
• MEM–AMERICA–WAR–AMERICAN–INDEPENDENCE — Parent war; Yorktown
  decisive; Treaty of Paris.
...
────────────────────────────────────────────────────────────
Yorktown: siege Sep–Oct 1781; French fleet; Cornwallis surrenders;
Treaty of Paris. Victory through coalition and endurance.
