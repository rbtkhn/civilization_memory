MEM–RUSSIA–HIST–PRIMARY–CHRONICLE — v3.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL · 20% COMPLIANT
Status: ACTIVE · CANONICAL · ARC-COMPLIANT (CIV–MEM–TEMPLATE v3.0)
Version: 3.0
Supersedes: MEM–RUSSIA–HIST–PRIMARY–CHRONICLE v2.7
...
────────────────────────────────────────────────────────────
This file preserves the *Primary Chronicle* as the **foundational
civilizational memory compiler** of early Rus’: the narrative framework
...
1) Invited rule and coercive legitimacy
2) Dynasty as time-structure
3) Orthodoxy as causal filter
4) Martyrdom and obedience ethics
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–RUSSIA–HIST–PRIMARY–CHRONICLE v3.0
────────────────────────────────────────────────────────────