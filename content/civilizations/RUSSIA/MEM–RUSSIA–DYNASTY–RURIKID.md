MEM–RUSSIA–DYNASTY–RURIKID — v3.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL
Status: ACTIVE · CANONICAL
Version: 3.0
Supersedes: MEM–RUSSIA–DYNASTY–RURIKID v2.7
...
────────────────────────────────────────────────────────────
This file preserves the Rurikids as the **foundational dynastic
infrastructure of Russian statehood**: the lineage through which early
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–RUSSIA–DYNASTY–RURIKID v3.0
────────────────────────────────────────────────────────────