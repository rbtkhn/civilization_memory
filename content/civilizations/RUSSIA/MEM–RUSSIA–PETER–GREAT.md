...
────────────────────────────────────────────────────────────
This file preserves Peter the Great as the reconstitutor of Russian state
power through enforced transformation: the ruler who fused autocracy,
coercive modernization, and imperial ambition to propel Muscovy into a
European great-power system.

For Russian civilizational memory, Peter represents continuity achieved
through rupture—modernization imposed from above to preserve sovereignty
