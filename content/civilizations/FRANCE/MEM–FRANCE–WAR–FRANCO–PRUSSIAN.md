MEM–FRANCE–WAR–FRANCO–PRUSSIAN — v1.1
...
────────────────────────────────────────────────────────────
This file preserves the Franco–Prussian War as **the catalytic humiliation
...
Niall Ferguson (ARC–FRANCE) on the war's place in the long arc to 1914:
...
────────────────────────────────────────────────────────────
III. REGIME WEAKNESS & COMMAND FRACTURE
────────────────────────────────────────────────────────────
The French state entered war without coherent command architecture.
...
• Emergence of parliamentary legitimacy
...
• Emphasis on deterrence and fortification
...
• Military defeat accelerates regime replacement.
• Territorial loss becomes civilizational memory.
...
• MEM–GERMANY–UNIFICATION — legitimacy transfer
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–FRANCE–WAR–FRANCO–PRUSSIAN — v1.1
────────────────────────────────────────────────────────────
