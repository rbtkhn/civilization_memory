MEM–FRANCE–NAPOLEON — v1.3
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL
Status: ACTIVE
Version: 1.3
Upgrade Type: ADDITIVE · COMPLIANCE RETROFIT
(CIV–MEM–TEMPLATE v1.1 + CIV–CORE–FRANCE Distinguished Scholars Rule; includes Andrew Roberts as additional secondary source)
Civilization: FRANCE
...
────────────────────────────────────────────────────────────
This file preserves Napoleon Bonaparte as the **revolutionary–imperial
reconstitutor of French state power**: the figure who terminated the
...
Niall Ferguson (ARC–FRANCE) on revolutionary debt and Napoleonic finance:
...
• MEM–FRANCE–WAR–FIRST–COALITION
• MEM–FRANCE–WAR–SECOND–COALITION
• MEM–FRANCE–WAR–THIRD–COALITION
...
• MEM–FRANCE–LAW–NAPOLEONIC–CODE
• MEM–FRANCE–WAR–NAPOLEON–WATERLOO — terminal defeat; declarative
  authority bound only while destinationless
• MEM–FRANCE–CONTINENTAL–SYSTEM — enforcement bound to figure;
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–FRANCE–NAPOLEON — v1.3
────────────────────────────────────────────────────────────
