MEM–FRANCE–WAR–SEVEN–YEARS — v1.5
...
Niall Ferguson (ARC–FRANCE) on fiscal-military constraint:
...
────────────────────────────────────────────────────────────
Failure reshapes elite perception.
...
• Settlement: Treaty of Paris (1763); France cedes Canada and French
  India; Duc de Choiseul led French negotiation (AUDIT–BARNES–FRANCE–
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–FRANCE–WAR–SEVEN–YEARS — v1.5
────────────────────────────────────────────────────────────
