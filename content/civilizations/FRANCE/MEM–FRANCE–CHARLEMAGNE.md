...
────────────────────────────────────────────────────────────
This file preserves Charlemagne as the **Frankish–Latin reconstitutor**
of post-Roman order: the ruler who fused Germanic kingship, Roman law,
and Christian universality into a renewed Western imperium.

For Francia, Charlemagne represents **continuity reclaimed through
imperial restoration**, not revolutionary rupture.

This file records how legitimacy was *assembled*, not whether it was
sustainable.

Contradictions are preserved without synthesis.

────────────────────────────────────────────────────────────
II. FRANKISH ORIGINS & DYNASTIC CONTINUITY
────────────────────────────────────────────────────────────
Charlemagne emerges from Merovingian decline and Carolingian ascent.

Structural conditions:
• Mayoral consolidation under Pepin III
• Land-based warrior aristocracy
• Ecclesiastical endorsement as political lubricant
...
• Roman imperial symbolism revived in the West
• Frankish military power translated into sacral legitimacy
...
────────────────────────────────────────────────────────────
IV. ADMINISTRATIVE & LEGAL ORDER
────────────────────────────────────────────────────────────
Charlemagne governs through layered delegation rather than uniformity.

Mechanisms:
• *Missi dominici* as inspection and correction agents
• Capitularies as directive guidance
• Counts operating within local custom
• Legal pluralism preserved under imperial frame
...
────────────────────────────────────────────────────────────
V. WAR, CONQUEST, & CHRISTIANIZATION
────────────────────────────────────────────────────────────
Military expansion sustains imperial coherence.
...
Christianization operates as a governance instrument.
...
────────────────────────────────────────────────────────────
VI. CULTURAL & EDUCATIONAL PROGRAM
────────────────────────────────────────────────────────────
The Carolingian Renaissance stabilizes authority symbolically.

Outcomes:
• Script standardization (Carolingian minuscule)
• Clerical education reforms
• Preservation and correction of Latin texts
...
────────────────────────────────────────────────────────────
VII. SUCCESSION & STRUCTURAL FRAGILITY
────────────────────────────────────────────────────────────
Imperial durability proves personal rather than institutional.

Aftermath:
• Division among heirs
• Treaty of Verdun (843)
• Gradual territorial differentiation
...
GERMANY:
• MEM–GERMANY–HOLY–ROMAN–EMPIRE (imperial continuity without unity)
• MEM–GERMANY–OTTONIAN–EMPIRE (sacral kingship inheritance)

ROME:
• MEM–ROME–LATE–EMPIRE (imperial administrative legacy)
...
────────────────────────────────────────────────────────────
Charlemagne encodes **legitimacy through synthesis**.

Memory function:
• Universalism assembled, not discovered
• Law, faith, and force braided into authority
• Empire sustained by correction rather than uniformity

Charlemagne defines Francia’s original legitimacy grammar.

────────────────────────────────────────────────────────────
X. CONTINUITY INSIGHTS (RAW)
────────────────────────────────────────────────────────────
• Empire can be restored through legitimacy synthesis.
• Sanctified authority outlasts conquest alone.
• Legal pluralism enables early imperial scale.
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–FRANCE–CHARLEMAGNE v1.2
────────────────────────────────────────────────────────────
