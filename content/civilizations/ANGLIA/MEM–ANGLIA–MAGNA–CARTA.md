...
────────────────────────────────────────────────────────────
II. ORIGIN CONDITIONS (ANTI-MYTH FRAME)
────────────────────────────────────────────────────────────
Magna Carta emerges from elite coercion, not moral awakening.

Context:
• Fiscal extraction to fund failed continental war
• Arbitrary royal justice and seizure
• Breakdown of feudal trust obligations
• Absence of predictable dispute resolution
• Baronial capacity for organized resistance

Constraint is **forced**, not granted.
Consent is **extracted**, not offered.

There is no theory of rights here.
There is a crisis of governability.

────────────────────────────────────────────────────────────
III. LAW AS NEGOTIATED LIMIT (STRUCTURAL SHIFT)
────────────────────────────────────────────────────────────
Magna Carta introduces a radical inversion for its time:
**the king is placed inside the law**.

Core constraints (original scope):
• Taxation tied to elite consent
• Limits on arbitrary imprisonment
• Protection of inherited custom
• Recognition of lawful judgment by peers

These are not universal rights.
They are **procedural guarantees for stakeholders with leverage**.
...
PRIMARY SOURCE ANCHOR A — CLAUSE 39 (1215)
...
precondition for coercion. Judgment precedes punishment.

Provenance Confidence: HIGH

────────────────────────────────────────

PRIMARY SOURCE ANCHOR B — CLAUSE 12 (1215)
...
principle is elite-limited but structurally revolutionary.

Provenance Confidence: HIGH

────────────────────────────────────────

PRIMARY SOURCE ANCHOR C — REISSUE CONFIRMATION (1225)
...
Reissue transforms coercion into precedent.

Provenance Confidence: HIGH

────────────────────────────────────────────────────────────
V. FAILURE, CIVIL WAR, AND SURVIVAL
────────────────────────────────────────────────────────────
Magna Carta fails immediately.
...
Yet it survives through **reissue**, not enforcement.

Its endurance is procedural, not moral.

Anglia learns a core lesson:
documents need not succeed immediately to matter permanently.

────────────────────────────────────────────────────────────
VI. PROCEDURAL MEMORY FORMATION
────────────────────────────────────────────────────────────
Magna Carta becomes precedent rather than program.

Over centuries it is:
• Re-cited in disputes
• Re-interpreted by courts
• Abstracted from baronial privilege
• Detached from original feudal context
...
────────────────────────────────────────────────────────────
VII. MISREADINGS, MYTH, AND UTILITY
────────────────────────────────────────────────────────────
Later eras universalize Magna Carta.

Transformations:
• Elite document → popular liberty symbol
• Feudal restraint → rights charter
• Tactical concession → moral origin story

These readings are historically false—
but civilizationally useful.

Myth amplifies durability.

Anglia tolerates myth because it reinforces constraint.
...
────────────────────────────────────────────────────────────
Enduring effects:
• Sovereign power made conditional
• Law elevated above will
• Negotiation normalized as governance tool
...
────────────────────────────────────────────────────────────
X. CROSS-REFERENCED MEM FILES (MANDATORY)
────────────────────────────────────────────────────────────
ANGLIA:
...
────────────────────────────────────────────────────────────
Magna Carta encodes **constraint before consent**.

Lessons:
• Power yields only under pressure
• Procedure precedes rights
• Failure does not negate precedent
...
• Cross-civilizational linkage standards
