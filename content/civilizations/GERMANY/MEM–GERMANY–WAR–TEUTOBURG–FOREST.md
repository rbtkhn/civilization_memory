MEM–GERMANY–WAR–TEUTOBURG–FOREST — v2.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL · ARC-COMPLIANT

Status: ACTIVE
Version: 2.1
Supersedes: MEM–GERMANY–WAR–TEUTOBURG–FOREST v2.0
...
Profile:
• Germanic noble (Cherusci tribe)
• Educated in Roman military culture
...
Arminius translates Roman procedure into vulnerability.
...
────────────────────────────────────────────────────────────
The engagement unfolds over three to four days as attritional destruction.

Characteristics:
• No set-piece battle
• Continuous ambush along the line of march
• Fragmentation of Roman units
• Exhaustion, panic, and command collapse
• Varus's suicide

Legions XVII, XVIII, and XIX are destroyed in detail.
Approximately 20,000 Roman soldiers killed.
...
• Permanent retirement of legion numbers XVII, XVIII, XIX
• Strategic retrenchment to the Rhine
...
> "Teutoburg marked Rome's recognition of limits, where administration
> could not safely precede control."
...
• Terrain can substitute for institutions.
• Total victory is unnecessary; denial suffices.
...
────────────────────────────────────────────────────────────
Primary Source Verbatim: 5 quotes (Velleius, Tacitus, Dio, Durant)

20% Quote Standard: MET (~23% verbatim content)
EQS Status: COMPLIANT

────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANY–WAR–TEUTOBURG–FOREST — v2.0
────────────────────────────────────────────────────────────
