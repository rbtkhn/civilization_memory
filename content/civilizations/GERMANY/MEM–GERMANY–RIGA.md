...
• MEM–GERMANY–HANSEATIC–LEAGUE — commercial integration
• MEM–GERMANY–TEUTONIC–ORDER — crusading context
• MEM–GERMANY–LUBECK — Hanseatic capital, model city
...
GEO MEMs (≥2):
• MEM–GERMANY–GEO–BALTIC–SEA — maritime context
• MEM–GERMANY–GEO–DAUGAVA–RIVER — riverine access (potential)
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANY–RIGA — v2.1
────────────────────────────────────────────────────────────
