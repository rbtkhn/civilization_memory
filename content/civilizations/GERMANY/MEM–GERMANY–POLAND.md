MEM–GERMANY–POLAND — v2.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL · ARC-COMPLIANT

Status: ACTIVE
Version: 2.1
Supersedes: MEM–GERMANY–POLAND v2.0
...
────────────────────────────────────────────────────────────
This file preserves **Germania–Poland** as a long-duration civilizational
interface defined by adjacency without absorption, repeated administrative
contact without stable fusion, and cyclical re-bordering under pressure
from larger continental forces.

The relationship is not linear and not progressive.
It oscillates between cooperation, rivalry, partition, and re-emergence.
...
────────────────────────────────────────────────────────────
19th-century nationalism hardens distinctions.

Polish memory emphasizes endurance through loss.
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANY–POLAND — v2.0
────────────────────────────────────────────────────────────
