...
• MEM–GERMANY–HANSEATIC–LEAGUE — led confederation
• MEM–GERMANY–HAMBURG — Hanseatic partner, land bridge terminus
• MEM–GERMANY–BREMEN — surviving Hanseatic city-state (contrast)
...
GEO MEMs (≥3):
• MEM–GERMANY–GEO–BALTIC–SEA — primary maritime orientation
• MEM–GERMANY–GEO–NORTH–SEA — secondary via Hamburg link
• MEM–GERMANY–GEO–TRAVE–RIVER — urban waterway (potential)
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANY–LUBECK — v2.1
────────────────────────────────────────────────────────────
