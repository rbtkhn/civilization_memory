MEM–GERMANY–WAR–SIEGE–VIENNA — v2.0
Civilizational Memory Codex · Memory File
ACTIVE · CANONICAL · ARC-COMPLIANT

Status: ACTIVE
Version: 2.1
Supersedes: MEM–GERMANY–WAR–SIEGE–VIENNA v2.0
...
The two sieges are remembered together because they encode learning
across time: initial exposure (1529) followed by mature containment
(1683).
...
After Mohács (1526), Vienna becomes the **last interior node** before
Germania itself is directly penetrated.

The city is not merely defended—it is **designated**.
...
────────────────────────────────────────────────────────────
IV. INTER-SIEGE LEARNING & FRONTIER INSTITUTIONALIZATION
────────────────────────────────────────────────────────────
Between 1529 and 1683, Germania absorbs pressure into structure.
...
────────────────────────────────────────────────────────────
VI. COALITION WAR & CONTROLLED UNIVERSALISM
────────────────────────────────────────────────────────────
Unlike earlier fragmentation, 1683 demonstrates bounded cooperation.
...
────────────────────────────────────────────────────────────
• Shock forces learning only if survival is achieved.
...
────────────────────────────────────────────────────────────
END OF FILE — MEM–GERMANY–WAR–SIEGE–VIENNA — v2.0
────────────────────────────────────────────────────────────
