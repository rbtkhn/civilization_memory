...
Derivation: ENTRY 0011 (cross-civ Austerlitz), SYNTHESIS 0005, RLL–FRANCIA–0009
...
Related MEMs: None ingested (gap)
Resolution Path: Ingest MEM–FRANCIA–DE–GAULLE, MEM–FRANCIA–FIFTH–REPUBLIC
...
ENTRY 0004
Source:
• MEM–FRANCIA–WAR–THIRTY–YEARS — v1.0
...
ENTRY 0007
Source:
• MEM–FRANCIA–WAR–FRANCO–PRUSSIAN — v1.0
...
• MEM–GERMANIA–WAR–NAPOLEON (cross-civilizational, referenced)
...
Axiom Implications:
• AXIOM FRANCIA-001 (Authority flows from declaration) requires
...
RLL Derivation:
• Supports RLL–FRANCIA–0008, 0009, 0010 (proposed)
...
• Ingested via MEMs: MEM–FRANCIA–JACQUERIE, MEM–FRANCIA–ESTATES–GENERAL,
  ...
  MEM–FRANCIA–DYNASTY–CAPET, MEM–FRANCIA–DYNASTY–VALOIS, MEM–FRANCIA–PARIS–NOTRE–DAME,
  MEM–FRANCIA–KNIGHTS–TEMPLAR, MEM–FRANCIA–WAR–POITIERS, MEM–FRANCIA–WAR–HUNDRED–YEARS–CRECY
...
• MEM–GERMANIA–WAR–NAPOLEON (defection cascade, force data)
• MEM–RUSSIA–WAR–NAPOLEON (endurance alternative)
• GERMANIA SYNTHESIS 0020 (Imperial Collapse Mechanics)

RLL Derivation Chain:
• RLL–FRANCIA–0004: Extraction collapse trigger conditions (Barnes)
• RLL–FRANCIA–0005: Paper divisions / force-ratio illusion (Mearsheimer)
• RLL–FRANCIA–0006: Defection = transfer mechanism (Tri-Frame)
• RLL–FRANCIA–0007: Post-hegemonic legitimacy absorption (Phase 3)
...
• RLL–FRANCIA–0001 (CANDIDATE): Declarative legitimacy precedes
  enforcement capacity as stability requirement
  Derivation: SYNTHESIS 0001, AXIOM FRANCIA-001
  Status: PROPOSED · NOT BOUND

• RLL–FRANCIA–0002 (CANDIDATE): Rupture accelerates renewal when
  civilizational grammar survives regime collapse
  Derivation: SYNTHESIS 0004, AXIOM FRANCIA-003
  Status: PROPOSED · NOT BOUND

• RLL–FRANCIA–0007 (CANDIDATE): Declarative legitimacy civilizations
  ...
  Derivation: SYNTHESIS 0005, DOCTRINE v0.4, GERMANIA SYNTHESIS 0020
...
PROPOSED RLL CANDIDATES:
• RLL–FRANCIA–0003 (CANDIDATE): Systemic war exposes claim-capacity
  divergence faster than limited war
  Derivation: SYNTHESIS 0003, ENTRIES 0006-0007
  Status: PROPOSED · NOT BOUND

• RLL–FRANCIA–0004 (CANDIDATE): Extraction systems collapse when
  liability visibility + legitimacy destination + defection opportunity align.
  Derivation: SYNTHESIS 0005 (DRAFT), BARNES CATALYST
  Frame: BARNES
  Cross-civ evidence: MEM–GERMANIA–WAR–NAPOLEON (Tauroggen cascade)
  Status: PROPOSED · NOT BOUND

• RLL–FRANCIA–0005 (CANDIDATE): Force ratios in extraction systems
  ...
  Frame: MEARSHEIMER
  Cross-civ evidence: MEM–GERMANIA–WAR–NAPOLEON (German contingent data)
  Status: PROPOSED · NOT BOUND

• RLL–FRANCIA–0006 (CANDIDATE): Defection in hegemonic systems produces
...
• RLL–FRANCIA–0008 (CANDIDATE): Force-ratio concentration requires interior
...
• RLL–FRANCIA–0009 (CANDIDATE): Defection succeeds when three conditions
...
• RLL–FRANCIA–0010 (CANDIDATE): Satellite state defection viability depends
...
• RLL–FRANCIA–0004/0005/0006/0007 proposed (derived from SYNTHESIS 0005)
• RLL–FRANCIA–0008/0009/0010 proposed (force-ratio + defection typology)
• ENTRY 0011 ingested (cross-civ Austerlitz divergence, first cross-civ entry)
• AXIOM FRANCIA-005 added (declarative authority limit condition)
